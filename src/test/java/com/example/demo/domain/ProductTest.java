...
class ProductTest {
    ...
    void testNewMenuItem() {
        Product product = new Product("New Pizza", 15.00, 10);

        assertEquals("New Pizza", product.getName(), "Name should match.");
        assertEquals(15.00, product.getPrice(), "Price should match.");
        assertEquals(10, product.getInv(), "Inventory should match.");
    }

    @Test
    void testNewMenuItemWithIngredient() {
        Product product = new Product("New Pizza", 15.00, 10);
